I18N = {
    "zh": {
        "Login | Galerie": "登录 | Galerie",
        "A Pinterest/Xiaohongshu photo wall style RSS reader": "一款 Pinterest/小红书照片墙式的 RSS 阅读器",
        "Please login first": "请先登录",
        "Endpoint URL": "节点 URL",
        "https://github.com/sekai-soft/galerie?tab=readme-ov-file#example-fever-endpoints": "https://github.com/sekai-soft/galerie/blob/master/README.zh.md#fever-%E8%8A%82%E7%82%B9%E7%A4%BA%E4%BE%8B",
        "What is this?": "这是什么？",
        "Username": "用户名",
        "Password": "密码",
        "Login": "登录",
...
def render_login(url_for_style_css: str, url_for_favicon_png: str, lang: str):
    return LOGIN_TEMPLATE \
        .replace('LOGIN_GALERIE', get_string('Login | Galerie', lang)) \
        ...
        .replace('ENDPOINT_URL_HELP_URL', get_string('https://github.com/sekai-soft/galerie?tab=readme-ov-file#example-fever-endpoints', lang)) \
